...
public class Robot{
	...
	private static final String myIPAddr = "128.2.109.20";
...
//		hostAddress = myIPAddr; //  un-comment once you've updated myIPAddr
		hostAddress = IP_6640;	// comment out once you've updated myIPAddr
	}
